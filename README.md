This is Sergio Andres Martinez CV, front end created with [Next.js](https://nextjs.org/) Project bootstrapped with [`create-next-app`](https://github.com/vercel/next.js/tree/canary/packages/create-next-app).
